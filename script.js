document.addEventListener("DOMContentLoaded", () => {
    ...
    function setActiveNav(page){
        ...
        homeNavIcon.src = "images/non-maroon-home-icon.png";
        walletNavIcon.src = "images/non-maroon-wallet-icon.png";
        showQRNavIcon.src = "images/non-maroon-show-QR-icon.png";
        scanQRNavIcon.src = "images/non-maroon-scan-qr-icon.png";
        messagesNavIcon.src = "images/non-maroon-messages-icon.png";
        ...
        switch(page){
            ...
            case "home":
                ...
                homeNavIcon.src = "images/maroon-home-icon.png";
                break;

            case "wallet":

               walletNav.classList.add("active");
               walletNavIcon.src = "images/maroon-wallet-icon.png";
               break;

            case "showQR":

               showQRNav.classList.add("active");
               showQRNavIcon.src = "images/maroon-show-QR-icon.png";
               break;

            case "scanQR":

               scanQRNav.classList.add("active");
               scanQRNavIcon.src = "images/maroon-scan-qr-icon.png";
               break;

            case "messages":

               messagesNav.classList.add("active");
               messagesNavIcon.src = "images/maroon-messages-icon.png";
               break;
